...
class FeatureExtractor:
    ...
    ***REMOVED***
    ...
    def __init__(self, input_signal, signal_length, fs_signal, start_time, end_time, signal_index=0):
        self.setup_signal_data(end_time, fs_signal, input_signal, signal_index, signal_length, start_time)
    ...
    def setup_signal_data(self, end_time, fs_signal, input_signal, signal_index, signal_length, start_time):
    ...
    def get_final_features_index(self):
        ...
        return self.final_ASE_val, self.final_Ti_val
